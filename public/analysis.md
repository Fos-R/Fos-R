...
Download **[here](./sample.pcap)** the sample data that has been generated by Fos-R with the following command line: `fosr augment-dataset -o sample.pcap -s 0 -d 1min -t 0 --tz CET`.
