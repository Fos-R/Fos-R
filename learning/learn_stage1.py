...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--bin-count", help="Number of bins per day (by default, 15-min bins)", type=int
    )
    ...
    data = {
        ...
        "metadata": {
            ...
            "input_file": os.path.basename(os.path.normpath(args.input)),
        },
    }
    ...
    plt.grid(True)
    plt.savefig(
        os.path.join(args.output, f"temporal_model.png"), dpi=300, bbox_inches="tight"
    )
    plt.clf()
