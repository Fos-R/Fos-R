    ...
    return [
        {
            ...
            "feature": "TCP flags",
            "metric": "JSD",
            "value": jsd(flow_real["tcp.flags"], flow_synthetic["tcp.flags"]),
        }
    ]
    ...
    results.append(
        {
            ...
            "feature": "TTL",
            "metric": "JSD",
            "value": jsd(flow_real["ip.ttl"], flow_synthetic["ip.ttl"]),
        }
    )
    results.append(
        {
            ...
            "feature": "Source IP",
            "metric": "JSD",
            "value": jsd(flow_real["ip.src"], flow_synthetic["ip.src"]),
        }
    )
    results.append(
        {
            ...
            "feature": "Dest. IP",
            "metric": "JSD",
            "value": jsd(flow_real["ip.dst"], flow_synthetic["ip.dst"]),
        }
    )
    results.append(
        {
            ...
            "feature": "L4 Protocol",
            "metric": "JSD",
            "value": jsd(flow_real["ip.proto"], flow_synthetic["ip.proto"]),
        }
    )
    results.append(
        {
            ...
            "value": wasserstein_distance(
                flow_real["ip.len"], flow_synthetic["ip.len"]
            ),
        }
    )
    return results
...
def evaluate_pcap(pcap_real, pcap_synthetic):
    ...
    results.append(
        {
            ...
            "feature": "n-grams",
            "metric": "BLEU",
            "value": bleu.compute_bleu(
                translation_corpus=[list(pcap_synthetic)],
                reference_corpus=[[list(pcap_real)]],
                max_order=4,
            )[0],
        }
    )
    ...
    results.append(
        {
            ...
            "metric": "ROUGE",
            "value": rouge.rouge_n(
                evaluated_sentences=list(pcap_synthetic),
                reference_sentences=list(pcap_eval),
                n=4,
            )[0],
        }
    )
    results.append(
        {
            "data": "Pcap file",
            "feature": "Bytes histograms",
            "metric": "JSD",
            "value": jsd(list(pcap_real), list(pcap_synthetic)),
        }
    )
    return results
...
def evaluate_weird(flow_real, flow_synthetic, flow_real_weird, flow_synthetic_weird):
    ...
    results.append(
        {
            "data": "Flow",
            "feature": '"Weird" occurrences ',
            "metric": "Ratio difference",
            "value": len(flow_synthetic_weird) / len(flow_synthetic)
            - len(flow_real_weird) / len(flow_real),
        }
    )
...
def evaluate_flow(flow_real, flow_synthetic):
    ...
    results.append(
        {
            ...
            "feature": "Source IP",
            "metric": "JSD",
            "value": jsd(flow_real["id.orig_h"], flow_synthetic["id.orig_h"]),
        }
    )
    results.append(
        {
            ...
            "feature": "Dest. IP",
            "metric": "JSD",
            "value": jsd(flow_real["id.resp_h"], flow_synthetic["id.resp_h"]),
        }
    )
    results.append(
        {
            ...
            "feature": "Dest. Port",
            "metric": "JSD",
            "value": jsd(flow_real["id.resp_p"], flow_synthetic["id.resp_p"]),
        }
    )
    results.append(
        {
            ...
            "feature": "L4 Protocol",
            "metric": "JSD",
            "value": jsd(flow_real["proto"], flow_synthetic["proto"]),
        }
    )
    results.append(
        {
            ...
            "feature": "L7 Protocol",
            "metric": "JSD",
            "value": jsd(flow_real["service"], flow_synthetic["service"]),
        }
    )
    results.append(
        {
            ...
            "metric": "JSD",
            "value": jsd(flow_real["history"], flow_synthetic["history"]),
        }
    )
    ...
    results.append(
        {
            ...
            "metric": "JSD",
            "value": jsd(
                flow_real[flow_real["conn_state"] != "-"]["conn_state"],
                flow_synthetic[flow_synthetic["conn_state"] != "-"]["conn_state"],
            ),
        }
    )
    results.append(
        {
            ...
            "feature": "L3 Protocol",
            "metric": "JSD",
            "value": jsd(flow_real["ip_proto"], flow_synthetic["ip_proto"]),
        }
    )
    ...
    results.append(
        {
            ...
            "metric": "EMD",
            "value": wasserstein_distance(
                flow_real["duration"], flow_synthetic["duration"]
            ),
        }
    )
    results.append(
        {
            "data": "Flow",
            "feature": "Source Bytes",
            "metric": "EMD",
            "value": wasserstein_distance(
                flow_real["orig_bytes"], flow_synthetic["orig_bytes"]
            ),
        }
    )
    results.append(
        {
            ...
            "metric": "EMD",
            "value": wasserstein_distance(
                flow_real["resp_bytes"], flow_synthetic["resp_bytes"]
            ),
        }
    )
    results.append(
        {
            "data": "Flow",
            "feature": "Source Packets",
            "metric": "EMD",
            "value": wasserstein_distance(
                flow_real["orig_pkts"], flow_synthetic["orig_pkts"]
            ),
        }
    )
    results.append(
        {
            "data": "Flow",
            "feature": "Dest. Packets",
            "metric": "EMD",
            "value": wasserstein_distance(
                flow_real["resp_pkts"], flow_synthetic["resp_pkts"]
            ),
        }
    )
    ...
    nice_names = {
        ...
        "resp_bytes": "Dest. Bytes",
        "orig_pkts": "Source Packets",
        "resp_pkts": "Dest. Packets",
        "id.orig_h": "Source IP",
        "id.resp_h": "Dest. IP",
        "id.resp_p": "Dest. Port",
        "proto": "L4 Protocol",
    ...
    results.append(
        {
            "data": "Flow",
            "feature": "All Discrete Features",
            "metric": "Vendi",
            "value": vendi.score(discrete_samples_synthetic, discrete_similarity)
            / len(discrete_samples_synthetic),
        }
    )

    continuous_samples_synthetic = flow_synthetic[
        ["duration", "orig_bytes", "resp_bytes", "orig_pkts", "resp_pkts"]
    ].sample(n=1000, random_state=0)
    # normalize
    for column in continuous_samples_synthetic.columns:
        continuous_samples_synthetic[column] = (
            continuous_samples_synthetic[column]
            - continuous_samples_synthetic[column].mean()
        ) / continuous_samples_synthetic[column].std()
    continuous_samples_synthetic = continuous_samples_synthetic.values.tolist()
    results.append(
        {
            "data": "Flow",
            "feature": "All Continuous Features",
            "metric": "Vendi",
            "value": vendi.score_K(cosine_similarity(continuous_samples_synthetic))
            / len(discrete_samples_synthetic),
        }
    )
    ...
    for feature in [
        ...
        le = LabelEncoder().fit(
            list(flow_real[feature]) + list(flow_synthetic[feature])
        )
    ...
    X_train, X_test, y_train, y_test = train_test_split(
        ...
        [0] * len(flow_real) + [1] * len(flow_synthetic),
        test_size=0.2,
        random_state=42,
    )
    ...
    results.append(
        {
            ...
            "metric": "C2ST Balanced Accuracy",
            "value": balanced_accuracy_score(y_test, y_pred),
        }
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--eval",
        required=True,
        help="Select the folder with Zeek logs of evaluation data.",
    )
    parser.add_argument(
        "--reference",
        required=True,
        help="Select the folder with Zeek logs of reference data.",
    )
    parser.add_argument(
        "--synthetic",
        required=True,
        help="Select the folder with Zeek logs of synthetic data.",
    )
    parser.add_argument(
        "--synthetic-name", required=True, help="The name of the synthetic data."
    )
    ...
    # conn.log
    try:
        flow_eval = pd.read_csv(
            os.path.join(args.eval, "conn.log"),
            header=8,
            engine="python",
            skipfooter=1,
            sep="\t",
        ...
        flow_ref = pd.read_csv(
            os.path.join(args.reference, "conn.log"),
            header=8,
            engine="python",
            skipfooter=1,
            sep="\t",
        ...
        flow_synthetic = pd.read_csv(
            os.path.join(args.synthetic, "conn.log"),
            header=8,
            engine="python",
            skipfooter=1,
            sep="\t",
    ...
    # weird.log
    try:
        flow_eval_weird = pd.read_csv(
            os.path.join(args.eval, "weird.log"),
            header=8,
            engine="python",
            skipfooter=1,
            sep="\t",
        ...
        flow_ref_weird = pd.read_csv(
            os.path.join(args.reference, "weird.log"),
            header=8,
            engine="python",
            skipfooter=1,
            sep="\t",
        ...
        flow_synthetic_weird = pd.read_csv(
            os.path.join(args.synthetic, "weird.log"),
            header=8,
            engine="python",
            skipfooter=1,
            sep="\t",
    ...
    for feature in [
        ...
        plt.hist(
            flow_ref[feature].values.tolist(),
            50,
            density=True,
            alpha=0.75,
            label="Reference",
        ...
        plt.hist(
            flow_synthetic[feature].values.tolist(),
            50,
            density=True,
            alpha=0.75,
            label="Synthetic",
        ...
        plt.title(
            f"Marginal distribution of {feature} for {os.path.split(args.synthetic)[-1]}"
        )
        ...
        plt.savefig(
            os.path.join(
                args.output,
                f"marginal-{feature}-{os.path.split(args.synthetic)[-1]}.png",
            ),
            dpi=300,
            bbox_inches="tight",
        )
    ...
    results_synthetic = results_synthetic + evaluate_weird(
        flow_eval, flow_synthetic, flow_eval_weird, flow_synthetic_weird
    )
    ...
    results_synthetic = results_synthetic + evaluate_tcp(
        flow_eval_tcp, flow_synthetic_tcp
    )

    print("\tREFERENCE DATA")
    results_ref = evaluate_flow(flow_eval, flow_ref)
    results_ref = results_ref + evaluate_weird(
        flow_eval, flow_ref, flow_eval_weird, flow_ref_weird
    )
    ...
    results_synthetic = {
        "method": args.synthetic_name,
        "results": {
            f"{r['feature']} {r['data']} {r['metric']}": r for r in results_synthetic
        },
    }
    results_ref = {
        "method": "Reference",
        "results": {
            f"{r['feature']} {r['data']} {r['metric']}": r for r in results_ref
        },
    }
    # results_ref  = { "method": "Reference", "results": results_ref }

    out_file = open(
        os.path.join(args.output, f"results-{os.path.split(args.synthetic)[-1]}.json"),
        "w",
    )
    json.dump(results_synthetic, out_file, indent=1)
    out_file = open(
        os.path.join(args.output, f"results-{os.path.split(args.eval)[-1]}.json"), "w"
    )
    ...
    pca_eval = pca.fit_transform(
        flow_eval[["duration", "orig_bytes", "resp_bytes", "orig_pkts", "resp_pkts"]]
    )
    pca_ref = pca.transform(
        flow_ref[["duration", "orig_bytes", "resp_bytes", "orig_pkts", "resp_pkts"]]
    )
    pca_synthetic = pca.transform(
        flow_synthetic[
            ["duration", "orig_bytes", "resp_bytes", "orig_pkts", "resp_pkts"]
        ]
    )
    ...
    plt.scatter(
        pca_synthetic[:, 0], pca_synthetic[:, 1], alpha=0.2, label="Synthetic data"
    )
    ...
    plt.savefig(
        os.path.join(args.output, f"pca-{os.path.split(args.synthetic)[-1]}.png"),
        dpi=300,
        bbox_inches="tight",
    )
    plt.clf()
