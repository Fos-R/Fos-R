...
pub struct UnconstrainedAutomataLibrary {
...
impl Default for UnconstrainedAutomataLibrary {
    fn default() -> Self {
        let mut lib = UnconstrainedAutomataLibrary {
            tcp_automata: vec![],
            udp_automata: vec![],
            icmp_automata: vec![],
        };
...
impl UnconstrainedAutomataLibrary {
...
pub struct UnconstrainedTadamGenerator {
    lib: Arc<UnconstrainedAutomataLibrary>,
}

impl UnconstrainedTadamGenerator {
    pub fn new(lib: Arc<UnconstrainedAutomataLibrary>) -> Self {
        UnconstrainedTadamGenerator { lib }
    }
}

#[allow(unused)]
impl Stage2 for UnconstrainedTadamGenerator {
    fn generate_tcp_packets_info(
        &self,
        mut flow: SeededData<FlowData>,
    ) -> Option<SeededData<PacketsIR<TCPPacketInfo>>> {
